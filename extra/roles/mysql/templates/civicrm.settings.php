...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal_user:{{ drupal_mysql_password.stdout }}@localhost/drupal_db?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civicrm_user:{{ civicrm_mysql_password.stdout }}@localhost:3306/civicrm_db?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
 define( 'CIVICRM_UF_BASEURL'      , 'https://{{ ansible_hostname }}.sitecaretaker.com/');
}
